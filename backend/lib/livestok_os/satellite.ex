defmodule LivestokOs.Satellite do
  ...
  def get_soil_factor(lat, long) do
    case api_key() do
      nil -> Application.get_env(:livestok_os, :default_soil_factor, 1.0)
  ...
  defp fetch_soil_factor_from_api(_lat, _long, _api_key) do
    ...
    Application.get_env(:livestok_os, :default_soil_factor, 1.0)
  end
  ...
  defp api_key do
    Application.get_env(:livestok_os, :satellite_api_key)
  end
end
